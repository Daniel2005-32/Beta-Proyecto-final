                    ...
                    <div>
                        ...
                        <div class="mt-6">
                            <?php if($product->isAuctionActive()): ?>
                                <span class="text-3xl font-black text-neon-purple"><?php echo e(number_format($product->getCurrentBid(), 2)); ?>€</span>
                                <span class="ml-2 text-gray-500 line-through text-lg"><?php echo e(number_format($product->price, 2)); ?>€</span>
