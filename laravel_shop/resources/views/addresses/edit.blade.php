<x-store-layout>
    <div class="py-12">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                <a href="{{ route('addresses.index') }}" class="text-gray-400 hover:text-neon-blue transition">
                ...
                <form action="{{ route('addresses.update', $address) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="zipcode" value="{{ old('zipcode', $address->zipcode) }}" required
                                   class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-neon-blue">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="number" value="{{ old('number', $address->number) }}" required
                                   class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-neon-blue">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="complement" value="{{ old('complement', $address->complement) }}"
                                   class="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-neon-blue">
                        </div>
